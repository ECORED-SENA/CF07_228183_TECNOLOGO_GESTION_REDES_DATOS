  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    .row.mb-5.justify-content-center.align-items-center.align-items-lg-stretch
      ...
      .col-12.col-md-8.col-lg-9
        .titulo-segundo
          h2 Verificando y transfiriendo datos
        p.mb-4 Profundizar en los conceptos, acciones y gestión del proceso de verificación y transmisión de datos, con base en los temas desarrollados en el componente formativo.
